...
public class CoursePage {
	...
	@FindBy(xpath="//p[contains(text(),'Configure your Course details and availabilty for ')]")
	...
	@FindBy(xpath="//input[@id='course-thumbnail']")
	...
	@FindBy(xpath="//div[@class='inputContainer'][h3[text()='Unique Selling Point 1*']]//input[@type='text']")
	WebElement usp1;
	...
	@FindBy(xpath="//div[@class='Row-Styles' and .//div[text()='MYNE']]//span[contains(@class, 'MuiSwitch')]//input[@type='checkbox']")
	WebElement toggleForCoupon;
	
	@FindBy(xpath="//div[@class='Row-Styles' and .//div[text()='MYNE']]//span[contains(@class, 'MuiCheckbox-root')]//input[@type='checkbox']")
	...
	@FindBy(xpath="//h1[text()='Starting Class link']/ancestor::div[@class='classLink']//input[@type='checkbox']")
	...
	@FindBy(xpath="//h1[text()='Soft Stop']/ancestor::div[@class='classLink']//input[@type='checkbox']")
	WebElement softStop;
	
	@FindBy(xpath="//h1[text()='Hard Stop']/ancestor::div[@class='classLink']//input[@type='checkbox']")
	WebElement hardStop;
	...
	public void enter_course_thumbnail(String thumbnail) {
		
		courseThumbnail.sendKeys(thumbnail);
	}
	...
	public double getInternationalDiscountedPrice() {
	...
	public double getInternationalDiscountPercentage() {
	...
	public boolean isCoursePaid() {
		...
		System.out.println(priceToggle);
